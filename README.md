...
tokenName: This is a string representing the name of the token.
abbrv: This is a string representing the abbreviation of the token.
totalSupply: This is an unsigned integer which is representing the total supply of the token.
